var window = wx;//zooble
var GameGlobal = wx.GameGlobal = {};//zooble
var requestAnimationFrame = wx.canvas.requestAnimationFrame;//zooble
var cancelAnimationFrame = wx.canvas.cancelAnimationFrame;//zooble
GameGlobal.document = {};//zooble
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Canvas() {
	  ...
	  // canvas.__proto__.__proto__ = new _HTMLElement2.default('canvas') //zooble, TypeError: Cannot read property 'call' of undefined
...
/***/ (function(module, exports) {
	...
	function Image() {
	  var image = wx.canvas.createImage() || wx.createImage()//zooble
